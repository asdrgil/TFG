...
(allergic_gluten child1 table2)
(allergic_gluten child5 table1)
(not_allergic_gluten child2 table1)
(not_allergic_gluten child3 table3)
(not_allergic_gluten child4 table2)
(not_allergic_gluten child6 table1)
(notexist sandw1)
(notexist sandw2)
(notexist sandw3)
(notexist sandw4)
